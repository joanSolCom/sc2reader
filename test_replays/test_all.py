...
class TestReplays(unittest.TestCase):
    ...
    #def test_teams(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/13.SC2Replay")
        #self.assertNotEqual(replay.player[1].team.number, replay.player[2].team.number)

        #replay = sc2reader.load_replay("./2.0.8.25604/mlg1.SC2Replay")
        #self.assertNotEqual(replay.player[1].team.number, replay.player[2].team.number)

    #def test_private_category(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/2.SC2Replay")
    ...
    #def test_standard_1v1(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/1.SC2Replay")
    ...
    #def test_2v2(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/7.SC2Replay")
        #self.assertEqual(replay.type, "2v2")

    #def test_3v3(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/3.SC2Replay")
    ...
    #def test_4v4(self):
        #replay = sc2reader.load_replay("./1.2.0.17326/9.SC2Replay")
        #self.assertEqual(replay.type, "4v4")

    #def test_ffa(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/8.SC2Replay")
        #self.assertEqual(replay.type, "FFA")
        #self.assertEqual(replay.winner.players[0].name, "Boom")

    #def test_unknown_winner(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/10.SC2Replay")
    ...
    #def test_random_player(self):
        ...
        #replay = sc2reader.load_replay("./1.2.2.17811/6.SC2Replay")
    ...
    #def test_us_realm(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/5.SC2Replay")
    ...
    #def test_kr_realm_and_tampered_messages(self):
        ...
        #"""
        #replay = sc2reader.load_replay("./1.1.3.16939/11.SC2Replay")
        #self.assertEqual(replay.expansion, "WoL")
    ...
    #def test_referee(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/14.SC2Replay")

    #def test_encrypted(self):
        #replay = sc2reader.load_replay("./1.2.2.17811/4.SC2Replay")
    ...
    #def test_hots_pids(self):
        #for replayfilename in [
            #"./2.0.3.24764/Akilon Wastes (10).SC2Replay",
            #"./2.0.3.24764/Antiga Shipyard (3).SC2Replay",
            #"./2.0.0.24247/molten.SC2Replay",
            #"./2.0.0.23925/Akilon Wastes.SC2Replay",
            #]:
    ...
    #def test_wol_pids(self):
        #replay = sc2reader.load_replay("./1.5.4.24540/ggtracker_1471849.SC2Replay")
        #self.assertEqual(replay.expansion, "WoL")
        #ability_pids = set([event.player.pid for event in replay.events if "AbilityEvent" in event.name])
    ...
    #def test_hots_hatchfun(self):
        #replay = sc2reader.load_replay("./2.0.0.24247/molten.SC2Replay")
        #player_pids = set([ player.pid for player in replay.players])
    ...
    #def test_hots_vs_ai(self):
        #replay = sc2reader.load_replay("./2.0.0.24247/Cloud Kingdom LE (13).SC2Replay")
        #self.assertEqual(replay.expansion, "HotS")
        #replay = sc2reader.load_replay("./2.0.0.24247/Korhal City (19).SC2Replay")
        #self.assertEqual(replay.expansion, "HotS")

    #def test_oracle_parsing(self):
        #replay = sc2reader.load_replay("./2.0.3.24764/ggtracker_1571740.SC2Replay")
        #self.assertEqual(replay.expansion, "HotS")
    ...
    #def test_resume_from_replay(self):
        #replay = sc2reader.load_replay("./2.0.3.24764/resume_from_replay.SC2Replay")

    #def test_clan_players(self):
        #replay = sc2reader.load_replay("./2.0.4.24944/Lunar Colony V.SC2Replay")
        #self.assertEqual(replay.expansion, "WoL")
        #self.assertEqual(len(replay.people), 4)

    #def test_WoL_204(self):
        #replay = sc2reader.load_replay("./2.0.4.24944/ggtracker_1789768.SC2Replay")
        #self.assertEqual(replay.expansion, "WoL")
        #self.assertEqual(len(replay.people), 2)

    #def test_send_resources(self):
        #replay = sc2reader.load_replay("./2.0.4.24944/Backwater Complex (15).SC2Replay")

    #def test_cn_replays(self):
        #replay = sc2reader.load_replay("./2.0.5.25092/cn1.SC2Replay")
    ...
    #def test_map_info(self):
        #replay = sc2reader.load_replay("./1.5.3.23260/ggtracker_109233.SC2Replay", load_map=True)
    ...
    def test_hotkey_plugin(self):
        from sc2reader.engine.plugins import HotkeyCount
        sc2reader.engine.register_plugin(HotkeyCount())
	
	replay = sc2reader.load_replay(
            "./2.0.5.25092/cn1.SC2Replay",
            engine=sc2reader.engine.GameEngine(plugins=[HotkeyCount()])
        )
    ...
    #def test_factory_plugins(self):
        ...
        #replay = factory.load_replay("./2.0.5.25092/cn1.SC2Replay")
    ...
    #def test_gameheartnormalizer_plugin(self):
        ...
        #replay = sc2reader.load_replay("./gameheart/gameheart.SC2Replay")
        ...
        #replay = sc2reader.load_replay("./gameheart/gh_sameteam.SC2Replay")
        #self.assertEqual(replay.events[0].frame, 0)
    ...
    #def test_replay_event_order(self):
        #replay = sc2reader.load_replay("./event_order.SC2Replay")
